...
class Calendar(calendar.HTMLCalendar):
    ...
    def Active_day(self):
        ...
        for festv in all_events:
            ...
            hash_table[common_day] += '<li><a style="color:#294047;background-color:#ede6e6" href="{}" class="added">{}<br> at {}</a></li>'.format(festv.event_url,festv.title,festv.start_at.strftime("%I:%M %p").lower())
